...
const HomePage = () => (
    ...
    <p>Prophesizing is no easy task — when looking at social phenomena (and web development is a social phenomenon), one knows well not to expect a simple linear projection from current events into the future.
    ...
    <h3>"It’s our responsibility as software developers to anticipate what’s to come and to deliver long term solutions accordingly."</h3>

    <p>Web development, as a set of technologies, practices, and institutes, is formed mainly by two forces: hardware, or more specifically, consumer devices, and the same old eternal pursuit of financial gain. When taking the task of predicting the future of web dev, an investigation of these two should be our starting point. In the last years we’ve seen an explosion in the diversity of consumer devices — smart watches, smart glasses, smart speakers, smart TVs, foldable smartphones, etc. — in this age of IoT (internet of things), we are hardly surprised when a new ‘thing’ puts the “smart” hat on and joins the club.
    </p>

    <h3>"There is an increase in the diversification of consumer devices."
</h3>

    <p>In the last years we’ve seen an explosion in the diversity of consumer devices — smart watches, smart glasses, smart speakers, smart TVs, foldable smartphones, etc. — in this age of IoT (internet of things), we are hardly surprised when a new ‘thing’ puts the “smart” hat on and joins the club.
